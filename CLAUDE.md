...
## Правила взаємодії (важливо)

- **Ніколи не робити `git commit` чи `git push` без явного дозволу щоразу** — дозвіл на весь план/таск не означає дозвіл на кожен окремий коміт.
- **Ніколи не робити `git merge`** — мержить тільки користувач особисто.
- Виконуючи багатокроковий план — зупинятись і пояснювати після кожного таску, а не мовчки пробігати весь план і звітувати в кінці.
- Перед тим як сказати "готово" на швидко виконану роботу — самоперевіритись ще раз, а не покладатись на швидкість як ознаку правильності.
